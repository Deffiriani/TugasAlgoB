...
string nomer[5]={"A001","A002","A003","A007","A008"};
    ...
    int jumlah,total,indeks,jum=5,jml,nb,jb,hb,totl1,totl2,du,membr,dis;
    double diskon;
...
if(membr=='y'||membr=='Y'){
    ...
    cout<<"Total Yang Harus Dibayar:"<<totl2-diskon<<endl;
    cout<<"Masukkan Uang           : ";cin>>du;
    cout<<"kembalian               : "<<du-(totl2-diskon);

}

else if(membr=='t'||membr=='T'){
